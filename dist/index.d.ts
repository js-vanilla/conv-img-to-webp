...
export type { CanvasLike, ConversionResult, ConvertToWebPOptions, ImageInput, OutputFor, RasterImage, ResourceLimitsOptions, SupportedImageType, WebPFeature, WebPFeatureCallback, WebPOutputKind } from './types.js';
